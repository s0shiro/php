    ...
    <main>
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Log in to your
                    account</h2>
            </div>
                        ...
                        <div class="mt-2">
                           <input type="email" name="email" id="email" autocomplete="email" required value="<?= old('email') ?>"
                            ...
                            <?php if (isset($errors['email'])) : ?>
                                <p class="text-red-500 text-sm mt-6"><?= $errors['email'] ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            <?php if (isset($errors['password'])) : ?>
                                <p class="text-red-500 text-sm mt-6"><?= $errors['password'] ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
